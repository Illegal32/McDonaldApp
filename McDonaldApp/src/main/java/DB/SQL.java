...
public class SQL {
    ...
    private static final String url = "jdbc:postgresql://localhost:5432/McDonald's";
    ...
    public void save() {
       ...
       user = new User();
        String sql = String.format("insert into patient (id, username, fin, password) values (%s, '%s', '%s','%s' )",
                user.getId(),
                user.getUsername(),
                user.getFin(),
                user.getPassword());
